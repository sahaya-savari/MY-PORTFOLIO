...
export function ParticleBackground({ className = '' }: ParticleBackgroundProps) {
  ...
  useEffect(() => {
    ...
    const createParticles = () => {
      // Reduced particle count for cleaner background
    ...
    const animate = () => {
      ...
      particles.forEach((particle) => {
        ...
        ctx.fillStyle = 'rgba(59, 130, 246, 0.15)'; // Reduced opacity
        ctx.fill();
      });
      ...
      particles.forEach((particle, i) => {
        particles.slice(i + 1).forEach((otherParticle) => {
          ...
          if (distance < 100) { // Reduced connection distance
            ...
            ctx.strokeStyle = `rgba(59, 130, 246, ${0.1 * (1 - distance / 100)})`; // Reduced opacity
